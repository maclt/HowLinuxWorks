...
int main(int argc, char *argv[]) {
	...
	// 4th argument => access pattern (sequential or random)
	bool random;
	...
	// define the order of the process in offset
	int i;
