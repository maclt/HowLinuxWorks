...
#define NLOOP_FOR_ESTIMATION 100000UL
#define NSECS_PER_MSEC 10000UL
#define NSECS_PER_SEC 10000000UL
...
int main(int argc, char *argv[]) {
	...
	if(nproc < 1) {
		fprintf(stderr, "<nprocc>(%d) should be >= 1\n", nproc);
		exit(EXIT_FAILURE);
	}
	...
	puts("estimating workload which takes just one milsecond");
